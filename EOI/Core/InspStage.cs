...
namespace EOI.Core
{
    ...
    public class InspStage : IDisposable
    {
        ...
        public bool Initialize()
        {
            ...
            VisionSequence.Inst.InitSequence(); // 2025.04.01 선생님이 이 부분 수정함
            VisionSequence.Inst.SeqCommand += SeqCommand; // 2025.04.01 선생님이 이 부분 수정함
        ...
        public bool OneCycle()
        {
            ...
            bool isDefect = false;
            if (!_inspWorker.RunInspect(out isDefect)) // 무조건적으로 검사가 끝나고 난 후 이미지가 나오게 실행. (Contour한정)
                return false;            
        ...
        public void StopCycle()
        {
			...
			VisionSequence.Inst.StopAutoRun(); // 2025.04.01 선생님꺼 추가.       
		}
